...
class GroundActor extends Actor {
    ...
    public void draw(Batch batch, float parentAlpha) {
        batch.draw(texture, 0, 0, 0, 0, (int)(VIEWPORT_WIDTH / PIXEL_TO_METER), (int)(0.1f / PIXEL_TO_METER));
    }
    ...
    Body createBody(World world) {
       ...
       //body.setTransform(0, 0, 0); // Bottom left corner
        ...
        rectangle.setAsBox(VIEWPORT_WIDTH, 0.1f); // Viewport width and 50cm height -> changed to 10cm
